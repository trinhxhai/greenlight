...
func (app *application) editConflictResponse(w http.ResponseWriter, r *http.Request, err error) {
	message := "unable to update the record duo to an edti conflic, please try again"
...
func (app *application) inactiveAccountResponse(w http.ResponseWriter, r *http.Request) {
	message := "your user account must be activated to access this resouce"
	app.errorResponse(w, r, http.StatusForbidden, message)
}

func (app *application) notPermittedResponse(w http.ResponseWriter, r *http.Request) {
	message := "your user acount doesn't have the necessary permission to access this resouce"
	app.errorResponse(w, r, http.StatusForbidden, message)
}
